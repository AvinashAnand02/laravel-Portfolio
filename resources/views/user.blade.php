...
$dbname = 'contact_form_db'; // Change to the database name (contact_form_db)
...
try {
    ...
    // Example: Insert user registration data
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <button class="ghost" id="signInReverse">Sign In</button>
                </div>
